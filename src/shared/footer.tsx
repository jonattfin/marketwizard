    ...
    <Stack>
      ...
      <Flex gap="6" justify="space-evenly" wrap="wrap">
        ...
        <Stack>
          ...
          <div>&nbsp;</div>
          <div><Link href={"#"}>{'What is a lazy portfolio?'}</Link></div>
          <div><Link href={"#"}>{'How to invest?'}</Link></div>
        </Stack>
        ...
        <Stack>
          ...
          <div>
            <Text textStyle={"sm"} color={"gray.500"}>
              The data presented here is fictitious and intended solely for demonstration purposes.
              We are currently integrating multiple APIs to provide actual data in the future.
            </Text>
          </div>
        </Stack>
      </Flex>
      ...
      <Stack>
        <div>
          <div>DISCLAIMER</div>
          <div>&nbsp;</div>
          Market Wizard is not a financial advisor.
