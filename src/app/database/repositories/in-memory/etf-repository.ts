  ...
  return [
    {
      ...
      theme: "SP500-ETFs",
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1663931932687-c4c2366a5c61?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 2,
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 3,
      ...
      imageUrl:
        "https://plus.unsplash.com/premium_photo-1681487769650-a0c3fbaed85a?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 4,
      name: "Defense ETFs",
      description:
        "The military and defense industry is a controversial topic. " +
      ...
      theme: "Defense-ETFs",
      imageUrl:
        "https://images.unsplash.com/photo-1489223339793-de491ea9108b?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      id: 5,
      ...
      theme: "AI-ETFs",
      imageUrl:
        "https://images.unsplash.com/photo-1612010167108-3e6b327405f0?q=80&w=640&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
}

const createEtfByIdType = (
  name?: string,
  imageUrl?: string,
  description?: string,
): EtfThemeByIdType => {
