  ...
  return (
    <>
      ...
      <Stack separator={<>&nbsp;</>}>
        ...
        <Link variant="underline" href={"#faq"}>
          Learn more about the index
        </Link>

        <div>&nbsp;</div>
        <Blockquote.Root>
          <Blockquote.Content>7 FEAR & GREED INDICATORS</Blockquote.Content>
        </Blockquote.Root>
      </Stack>
      <div>&nbsp;</div>
      <Stack
      ...
      <div id={"faq"}>
        <Blockquote.Root>
          <Blockquote.Content>FEAR & GREED INDEX FAQs</Blockquote.Content>
        </Blockquote.Root>
        ...
        <Stack separator={<div>&nbsp;</div>}>
          ...
          <Text textStyle="l">
            The Fear & Greed Index is a way to gauge stock market movements and
            whether stocks are fairly priced. The theory is based on the logic
            that excessive fear tends to drive down share prices, and too much
            greed tends to have the opposite effect.
          </Text>

          <Text textStyle="xl">How is Fear & Greed Calculated?</Text>
          <Text textStyle="l">
            The Fear & Greed Index is a compilation of seven different
            indicators that measure some aspect of stock market behavior. They
            are market momentum, stock price strength, stock price breadth, put
            and call options, junk bond demand, market volatility, and safe
            haven demand. The index tracks how much these individual indicators
            deviate from their averages compared to how much they normally
            diverge. The index gives each indicator equal weighting in
            calculating a score from 0 to 100, with 100 representing maximum
          ...
          <Text textStyle="l">
            Every component and the Index are calculated as soon as new data
            becomes available.
          </Text>

          <Text textStyle="xl">How to use Fear & Greed Index?</Text>
          <Text textStyle="l">
            The Fear & Greed Index is used to gauge the mood of the market. Many
            investors are emotional and reactionary, and fear and greed
            sentiment indicators can alert investors to their own emotions and
            biases that can influence their decisions. When combined with
            fundamentals and other analytical tools, the Index can be a helpful
            way to assess market sentiment.
          </Text>
        </Stack>
      </div>
    </>
