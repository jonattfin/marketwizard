...
export default function LazyPortfolioDetails({
  id,
}: Readonly<LazyPortfolioDetailsType>) {
    ...
    <Stack>
      ...
      <Breadcrumb.Root>
        <Breadcrumb.List>
          ...
          <Breadcrumb.Item>
            <Breadcrumb.Link href="/lazy-portfolios">
              Lazy Portfolios
            </Breadcrumb.Link>
          </Breadcrumb.Item>
          <Breadcrumb.Separator />
          <Breadcrumb.Item>
            <Breadcrumb.CurrentLink data-testid={"portfolio-title"}>
              {portfolio?.name}
